...
def dLoad(ins=498):    
    ...
    for i in range(12, 13):
        sources.append(readTxtFile("ArSummarizer/TSimAr/resources/Simplification_Datasets/References/{}.txt".format(i)))
        hReferences.append(readTxtFile("ArSummarizer/TSimAr/resources/Simplification_Datasets/hSimplification/{}.txt".format(i)))        
        predFourier.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/Fourier/{}.txt".format(i)))
        
        predAraT5.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/UBC-NLP-AraT5/{}.txt".format(i)))
        predFacebook.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/Facebook-mBART-large-50/{}.txt".format(i)))
        predGoogle.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/google-mt5-base/{}.txt".format(i)))
        predArabicT5.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/arabic-t5/{}.txt".format(i)))
        predArabicT5Small.append(readTxtFile("ArSummarizer/TSimAr/resources/Rephrase/arabic-t5-small/{}.txt".format(i)))     
...
allMetricsFile = open("ArSummarizer/TSimAr/resources/Rephrase/allMetrics.txt", "w", encoding="utf-8")
